...
export var CognitoUser = /*#__PURE__*/ function() {
    ...
    _proto.sendCustomChallengeAnswer = function sendCustomChallengeAnswer(answerChallenge, clientMetaData) {
        var _this = this;
        return promisifyStructured(function(cb) {
            return _this.origUser.sendCustomChallengeAnswer(answerChallenge, cb, clientMetaData);
        });
    };
    ...
    _proto.forgotPassword = function forgotPassword(clientMetaData) {
        var _this = this;
        return promisifyStructured(function(cb) {
            return _this.origUser.forgotPassword(cb, clientMetaData);
        });
    };
    ...
    _proto.completeNewPasswordChallenge = function completeNewPasswordChallenge(newPassword, requiredAttributeData, clientMetadata) {
        var _this = this;
        return promisifyStructured(function(cb) {
            return _this.origUser.completeNewPasswordChallenge(newPassword, requiredAttributeData, cb, clientMetadata);
        });
    };
